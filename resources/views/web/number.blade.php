            ...
            <header class="row m-0 fixed-header top-menu bg-red">
                ...
                <div class="page-content">
                    <div class="page-video">
                        <video width="100%" height="260px" poster="{{ asset('web/storage/videos/old/numbers_1.png') }}" controls
                            class="player">
                            <source src="{{ asset('web/storage/videos/MM_Count_1080.mov') }}" type="video/mp4">
                            <source src="{{ asset('web/storage/videos/MM_Count_1080.ogg') }}" type="video/ogg">
                        </video>
                        <section class="border-bottom py-3" id="detail">
                            <div class="container-fluid">
                                <div class="d-flex justify-content-between align-items-start flex-wrap">
                                    <div class="flex-1 mr-2">
                                        <h1 class="h5 page-video__title mb-2 font-weight-bold"> အရေအတွက်များအား လေ့လာသင်ယူမှတ်သားခြင်း</h1>
