            ...
            <header class="row m-0 fixed-header top-menu bg-red">
                ...
                <div class="page-content">
                    <div class="page-video">
                        <video width="100%" height="260px" poster="{{ asset('web/storage/videos/old/colors_1.png') }}" controls class="player">
                            <source src="{{ asset('web/storage/videos/MM_Colors_1080.mov') }}" type="video/mp4">
                            <source src="{{ asset('web/storage/videos/MM_Colors_1080.ogg') }}" type="video/ogg">
                        </video>
                        <section class="border-bottom py-3" id="detail">
                            <div class="container-fluid">
                                <div class="d-flex justify-content-between align-items-start flex-wrap">
                                    <div class="flex-1 mr-2">
                                        <h1 class="h5 page-video__title mb-2 font-weight-bold"> အရောင်များအား
                        ...
                        <section class="videos py-1 col-md-6 m-auto" id="otherVideos">
                            ...
                            <div class="border-bottom p-2">
                                <a class="section-videos-item px-1" href="{{ url('educationvideo/vagetable') }}">
                                    <div class="section-videos-item__picture w-100"><img
